...
our-civic-atlas: A geospactial planning app. Never forget where you put your keys or run a multimillion dollar infrastructure project.
RustyWeb: web search, scrape, aggregate, built from Rust and Datawave connects to the RustyRed database, Redis (Valkey), Postgres. Very modular set up according to your workflow.
